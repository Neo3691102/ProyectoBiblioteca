...
public class Library {
    public static void main(String[] args) throws MiExcepcion {
        ...
        Usuario usuarioid3 = cn.obtenerusuarioPorIDCN(3);
        System.out.println("El usuario con el id#3 -> " + usuarioid3);


        System.out.println("-----------------Actualizar usuario------------------------");
        Usuario usuarioParaUPDATE = cn.obtenerusuarioPorIDCN(3);
        usuarioParaUPDATE.setNombre("Abigail");
        usuarioParaUPDATE.setPassword("contraseña actualizada!");
        usuarioParaUPDATE.setCorreo("Aupdated@mail.com");
        cn.actualizarUsuarioCN(usuarioParaUPDATE);
