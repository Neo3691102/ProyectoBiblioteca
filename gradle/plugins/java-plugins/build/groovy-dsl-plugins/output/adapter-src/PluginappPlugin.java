...
/**
 * Precompiled pluginapp script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class PluginappPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Pluginapp").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("pluginversion");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Pluginapp").asSubclass(BasicScript.class);
